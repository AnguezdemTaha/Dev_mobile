...
public class AddEmploit3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Ajouter un créneau (2ème année)");
        ...
        scolarete1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent(AddEmploit3.this, Listcours.class);
                startActivity(in);
            }
        });
        messages1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(AddEmploit3.this, Listmessage.class);
                startActivity(in);
            }
        });
        evenement1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(AddEmploit3.this, Listevent.class);
                startActivity(in);
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.item88:
                Intent in88 = new Intent(AddEmploit3.this, Menuetudiant.class);
                startActivity(in88);
                break;

            case R.id.item10:
                Intent in10 = new Intent(AddEmploit3.this, Login.class);
                startActivity(in10);
                break;

            case R.id.item9:
                Intent in9 = new Intent(AddEmploit3.this, Emploit3.class);
                startActivity(in9);
                break;
